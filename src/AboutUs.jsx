...
function AboutUs() {
  return (
    <div className="about-us-container">
      ...
      Ya sea que sea un jardinero experimentado o que recién esté comenzando su camino hacia la ecología, estamos aquí para ayudarlo en cada paso del camino. No dude en explorar nuestra colección, hacer preguntas y dejar que lo ayudemos a encontrar la planta perfecta para su hogar u oficina.
      </p>
      ...
      <p className="about-us-content">
      Únase a nuestra misión de crear un mundo más verde y saludable. Visite Paradise Nursery hoy y experimente la belleza de la naturaleza a su puerta.
      </p>
    </div>
  );
}
